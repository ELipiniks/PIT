    ...
    <div class="content-wrapper">
        ...
        <header>
            ...
            <div class="header-menu">
                ...
                <span onclick="openNav()">&#9776; SĀKUMS</span>
            ...
            <!-- Custom paziņojums -->
            <h2>Laipni lūgts, <?= $_SESSION['name'] ?></h2>
        </header>
        <main>
            <!-- Youtube video  -->
            <iframe width="100%;" height="100%;" src="https://www.youtube.com/embed/C4UYodhgnd4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
        </main>
