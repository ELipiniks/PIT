...
<div class="content-wrapper">
    ...
    <header>
        ...
        <div class="header-menu">
            ...
            <span onclick="openNav()">&#9776; KARTE</span>
        ...
        <!-- Custom paziņojums -->
        <h2><?= $_SESSION['name'] ?>, neapmaldies, iepazīsti teritoriju! </h2>
    </header>
    <main>
      <iframe src="/images/2020_PVG_Shema.pdf" width="100%" style="height:100%"></iframe>
    </main>
